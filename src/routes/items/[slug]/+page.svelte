...
{:else}
  ...
  <div class="max-w-2xl mx-auto p-8 text-center">
    <h1 class="text-2xl font-mono font-bold mb-4">404: Item Not Found</h1>
    <p class="text-gray-600 mb-4">
      Item <code class="bg-gray-100 px-2 py-1 rounded font-mono">{slug}</code> does not exist.
    </p>
    <div class="space-x-4">
      <a href="/items" class="text-blue-600 hover:underline">Browse Items</a>
